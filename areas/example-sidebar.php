...
<body>
	...
	<section class="sidebar-layout">
		...
		<aside class="left nav nav-style-grey">
			<?php build_vertical_navigation('grey','open',false,$items_aside,true,'home','id_1','hide-on-small over-aside'); ?>
		</aside>
		...
		<main id="main" class="bk-white full-on-small">
			...
			<div class="row margin-left margin-right">
				<div class="col-4 half-on-medium">
				...
				<div class="col-4 full-on-medium ct-to-double-octave-on-medium">
