	...
	<div class="wrapper">
		...
		<div class="demo">
			...
			<section class="row">
				...
				<div class="title"><h3>Colors</h3></div>
			...
			<section id="Buttons_Section">
				...
				<div class="title"><h3>Buttons</h3></div>
			...
			<section id="Forms_Section">
				...
				<div class="title"><h3>Forms</h3></div>
			...
			<section id="Navigation_Section">
				...
				<div class="title"><h3>Vertical Navigation</h3></div>
			...
			<section id="Navigation_Section">
				...
				<div class="title"><h3>Misc</h3></div>
			...
			<section id="Navigation_Section">
				...
				<div class="title"><h3>Cards & Tabs</h3></div>
			...
			<section id="Typography_Section">
				...
				<div class="title"><h3>Typography</h3></div>
			...
			<section id="Images_Section">
				...
				<div class="title"><h3>Images</h3></div>
				...
				<article>
					...
					<div class="row row-spaced">
						<h4>Styles</h4>
						<div class="col-2">
							<figure class="square regular margin-all">
			...
			<section id="Javascript_Section">
				...
				<div class="title"><h3>Javascript elements</h3></div>
			...
			<section id="Tables_Section">
				...
				<div class="title"><h3>Tables</h3></div>
			...
			<section id="Graphs_Section">
				...
				<div class="title"><h3>Graphs</h3></div>
				...
				<div class="row">
					<div class="col-4">
						<?php build_chart('test-chart','bar',$bar_labels_1,$bar_series_1,'mixed','ct-perfect-fourth'); ?>
					</div>
					<div class="col-4">
						<?php build_chart('second-chart','donut','',$series_donut_1,'error','ct-perfect-fourth'); ?>
					</div>
					<div class="col-4">
						<?php build_chart('another-chart','bar-stacked',$bar_labels_2,$bar_series_2,'success','ct-perfect-fourth'); ?>
					</div>
				</div>

				<div class="row">
					<div class="col-4">
						<?php build_chart('test-chart-2','line',$labels_2,$series_2,'info line-dashed','ct-perfect-fourth'); ?>
					</div>
					<div class="col-4">
						<?php build_chart('second-chart-2','pie','',$series_pie_1,'mixed','ct-perfect-fourth'); ?>
					</div>
					<div class="col-4">
						<?php build_chart('another-chart-2','line',$labels_1,$series_1,'corp-mixed line-solid','ct-perfect-fourth'); ?>
					</div>
				</div>
